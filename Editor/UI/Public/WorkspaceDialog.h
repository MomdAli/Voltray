...
namespace Voltray::Editor::UI
{
    ...
    public:
         ...
         */
        using WorkspaceCallback = std::function<void(const Voltray::Utils::Workspace *)>;
    ...
    private:
        ...
        static std::vector<Voltray::Utils::Workspace> s_Workspaces;
        ...
        static void OnWorkspaceSelected(const Voltray::Utils::Workspace *workspace);
