...
namespace Editor
{
    namespace Assets
    {
        ...
        void AssetBrowser::Draw(const ImVec2 &windowSize)
        {
            ...
            if (m_needsRefresh)
            {
                Editor::Assets::AssetBrowserState state;
            ...
            std::vector<Editor::Assets::AssetItem> filteredItems;
            ...
            switch (m_viewMode)
            {
            case Editor::Assets::AssetViewMode::Grid:
                RenderAssetGrid();
                break;
            case Editor::Assets::AssetViewMode::List:
                RenderAssetList();
                break;
            case Editor::Assets::AssetViewMode::Details:
                RenderAssetDetails();
                break;
            }
        ...
        void AssetBrowser::RenderToolbar(float windowWidth)
        {
            ...
            {
                m_viewMode = Editor::Assets::AssetViewMode::Grid;
            }
            ImGui::SameLine();
            if (ImGui::Button("List"))
            {
                m_viewMode = Editor::Assets::AssetViewMode::List;
            }
            ImGui::SameLine();
            if (ImGui::Button("Details"))
            {
                m_viewMode = Editor::Assets::AssetViewMode::Details;
            }
            ImGui::SameLine();
            ImGui::Text("|");
            ImGui::SameLine();
            ...
            if (m_viewMode == Editor::Assets::AssetViewMode::Grid)
            {
                ImGui::Text("Size:");
                ImGui::SameLine();
        ...
        void AssetBrowser::RenderAssetItem(const Editor::Assets::AssetItem &item, bool isGrid)
        {
        ...
        bool AssetBrowser::PassesSearchFilter(const Editor::Assets::AssetItem &item) const
        {
        ...
        void AssetBrowser::HandleItemSelection(const Editor::Assets::AssetItem &item)
        {
        ...
        void AssetBrowser::HandleItemDoubleClick(const Editor::Assets::AssetItem &item)
        {
            if (item.isDirectory)
            {
            ...
            {
                // TODO: Handle file opening based on type
